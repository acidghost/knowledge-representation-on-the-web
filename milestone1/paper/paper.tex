...
\begin{figure}[ht]
	\centering
	\includegraphics[width=.7\textwidth]{img/use-case-diagram.png}
...
The web application may be improved by provided extended support. New queries may be added. %TODO finish this
